<?php
// if is new product detail page template
if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/products/template/" . $_GET["product"] . ".php")) {
	require($_SERVER['DOCUMENT_ROOT'] . "/products/template/" . $_GET["product"] . ".php");
} else {
