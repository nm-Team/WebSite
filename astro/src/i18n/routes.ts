...
export const routeManifest: RouteEntry[] = [
  ...
  },
  {
    ...
    slug: ['join'],
    kind: 'static-page',
    sourcePhpPath: '/join/index.php',
    pageTitle: 'join.join_requirement_page.title',
    pageKeywords: '欢迎你,加入nmTeam,招人,招贤纳财',
    pageDescription: 'join.join_requirement_page.description',
    pageHeadCss: ['/src/css/jobpage.css'],
    pageHeadJs: [],
  ...
  },
  {
    ...
    slug: ['join', 'forum'],
    kind: 'redirect-page',
    sourcePhpPath: '/join/forum.php',
    pageTitle: 'join.join_register_page.title',
    pageKeywords: '欢迎你,加入nmTeam,招人,招贤纳财',
    pageDescription: 'join.join_register_page.description',
    pageHeadCss: [],
    pageHeadJs: [],
    pageBodyJs: [],
    pageImage: '',
  ...
  },
  {
    ...
    slug: ['questionnaire-ended'],
    kind: 'static-page',
    sourcePhpPath: '/blackboard/questionnaire/index.php',
    pageTitle: '',
    pageKeywords: '',
    pageDescription: '',
    pageHeadCss: [],
  ...
  },
  {
    ...
    slug: ['language'],
    kind: 'static-page',
    sourcePhpPath: '/language.php',
    pageTitle: 'language.page.title',
    pageKeywords: '',
    pageDescription: 'language.page.tip',
    pageHeadCss: ['/src/css/lan.css'],
    pageHeadJs: [],
    pageBodyJs: [],
    pageImage: '',
    pageUpdate: '',
  ...
  },
  {
    ...
    slug: ['sitemap'],
    kind: 'static-page',
    sourcePhpPath: '/sitemap.php',
    pageTitle: 'sitemap.title',
    pageKeywords: 'site map,sitemap,网站地图,站点地图',
    pageDescription: 'sitemap.description',
    pageHeadCss: [],
    pageHeadJs: [],
    pageBodyJs: [],
    pageImage: '',
