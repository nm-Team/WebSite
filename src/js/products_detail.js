    ...
    for (bl in blockJson) {
        ...
        switch (blockJson[bl]['type']) {
            case "subtitle":
                ...
                break;
            case "single":
                document.getElementById(bLId).innerHTML = `<div class="singleMain ${attrList.mediaType ? "" : "nomedia"}"><p class="word">` + checkTip(attrList.p, attrList) + `</p>` + (attrList.mediaType == "img" ? `<img class="img" style="` + attrList.mediaStyle + `" ` + attrList.specialAttr + ` src="` + attrList.media + `" ondragstart="return false;" title="` + attrList.mediaTitle + `" alt="` + attrList.mediaTitle + `" aria-label="` + attrList.mediaTitle + `" />` : (attrList.mediaType == "video" ? `<video class="img" style="` + attrList.mediaStyle + `" ` + attrList.specialAttr + ` src="` + attrList.media + `" ondragstart="return false;" autoplay="autoplay" muted="muted" controls="false" controlslist="nodownload" title="` + attrList.mediaTitle + `" alt="` + attrList.mediaTitle + `" aria-label="` + attrList.mediaTitle + `"></video>` : "")) + `</div>`;
                break;
            case "img":
                document.getElementById(bLId).innerHTML = `` + (attrList.mediaType == "img" ? `<img class="img" style="` + attrList.mediaStyle + `" ` + attrList.specialAttr + ` src="` + attrList.media + `" ondragstart="return false;" title="` + attrList.mediaTitle + `" alt="` + attrList.mediaTitle + `" />` : (attrList.mediaType == "video" ? `<video class="img" style="` + attrList.mediaStyle + `" ` + attrList.specialAttr + ` src="` + attrList.media + `" ondragstart="return false;" autoplay="autoplay" muted="muted" controls="false" controlslist="nodownload" title="` + attrList.mediaTitle + `" alt="` + attrList.mediaTitle + `" aria-label="` + attrList.mediaTitle + `"></video>` : "")) + `<p>` + checkTip(attrList.p, attrList) + `</p>`;
                break;
            case "buttons":
