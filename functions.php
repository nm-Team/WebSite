    ...
    ?><div id="fcont">
            <div class="footer-body">
                <div class="footer-table">
                    ...
                    <div class="row">
                        <button id="footer_selectLanguageButton" onclick="window.location.href = window.location.origin + '/language.php?bks=' + escape(window.location.href);"><i><svg t="1638693385062" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
